"""
ASRE Comprehensive Backtest Engine v2.1 - FINAL FIX
===================================================
Properly handles Backtester attributes
"""
...
if __name__ == "__main__":
    print("=" * 100)
    print("ASRE BACKTEST ENGINE v2.1 - FINAL".center(100))
    print("=" * 100)

    results = run_backtest('NVDA', start_date='2024-01-01', use_floor=True, verbose=True)
    print("\n✅ Backtest complete! Results stored in 'results' dict")
    print(f"   Backtester object: results['backtest_obj']")
    print(f"   Dataframe: results['dataframe']")